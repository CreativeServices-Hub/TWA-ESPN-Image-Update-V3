...
lib.ssMetadata = [
		{name:"320x250_atlas_1", frames: [[0,0,1280,418],[602,1506,885,333],[1282,0,600,500],[0,420,600,500],[602,420,600,500],[1204,502,600,500],[0,922,600,500],[602,922,600,500],[1204,1004,600,500],[0,1424,600,500]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Expandido();
	this.instance.setTransform(-98,115,0.3109,0.3109);
...
p.nominalBounds = new cjs.Rectangle(-98,0,398,250);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.instance_2 = new lib.RIGHTLOGO();
	this.instance_2.setTransform(183,9,0.1074,0.1074);
...
p.nominalBounds = new cjs.Rectangle(62,116.3,389.1,454.59999999999997);
// library properties:
lib.properties = {
